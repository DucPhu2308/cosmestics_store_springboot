    ...
    <div class="row">
        <div class="col-12">
            <div class="table-responsive">
                <button class="btn btn-sm btn-primary" onclick="create()"> Thêm giỏ hàng</button>
                        ...
                        <c:if test="${i_cart.active == true}">
                            <tr class="rowCart${temp}">
                                <td>
                                    ...
                                    <form action="/cart/updateCart/${i_cart.id}" method="post" class="form_update${temp}" style="display: none;">
                                        <input  type="text" value="${i_cart.name}" name="nameCart"/>
                                        <input type="submit" value="Thay đổi">
                                        <div class="update_cancel" style="margin-top:10px;">
                                            <button class="btn btn-sm btn-primary" onclick="cancel${temp}()">Hủy</button>
                                        </div>
                                    </form>
