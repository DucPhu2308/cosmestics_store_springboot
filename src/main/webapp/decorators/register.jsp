        ...
        <div class="block_image">
            <div class="block_image_container">
                ...
                <div class="block_logo_slogan">
                    <p style="font-size: 20px; text-align: center; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Trang online bán hàng mỹ phẩm chất lượng cao, uy tín và giá cả hợp lý. Orishop cung cấp các sản phẩm mỹ phẩm từ các thương hiệu nổi tiếng trong và ngoài nước</p>
                </div>
            </div>
